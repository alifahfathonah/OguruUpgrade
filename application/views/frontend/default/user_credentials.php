                ...
                <div class="user-dashboard-box">
                    <div class="user-dashboard-sidebar">
                        ...
                        <div class="user-dashboard-menu">
                            <ul>
                                <li><a href="<?php echo site_url('home/profil/profil_saya'); ?>"><?php echo get_phrase('profile'); ?></a></li>
                                <li class="active"><a href="<?php echo site_url('home/profil/akun'); ?>"><?php echo get_phrase('account'); ?></a></li>
