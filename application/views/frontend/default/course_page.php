      ...
      <div class="col-lg-8">
        ...
        <div class="created-row">
          <span class="created-by">
            Dibuat oleh 
            <a href="<?php echo site_url('home/edukator_info/'.$course_details['user_id']); ?>"><b><?php echo $instructor_details['first_name'].' '.$instructor_details['last_name']; ?></b></a>
          </span>
  ...
  <div class="course-sidebar natural">
    ...
    <div class="course-sidebar-text-box">
      ...
      <div class="includes">
        ...
        <ul>
            <li><i class="far fa-user"></i>Pengajar<br><?php echo $instructor_details['first_name'].' '.$instructor_details['last_name']; ?>
          </li>
          </li>
          <?php if($course_details['tipe'] == 'online'){ ?>
